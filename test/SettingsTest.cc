...
ASSERT_EQ(1280, settings.

getResHor()

);
ASSERT_EQ(sf::Vector2u(1280, 720)
.x, settings.
...
ASSERT_EQ(800, settings.

getResHor()

);
ASSERT_EQ(sf::Vector2u(800, 600)
.x, settings.
...
ASSERT_EQ(1920, settings.

getResHor()

);
ASSERT_EQ(sf::Vector2u(1920, 1080)
.x, settings.
